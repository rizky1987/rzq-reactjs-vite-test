...
const ViewProductModal = ({isOpen, onClose, proccess}: ProductViewModalProps) => {
          ...
          <div className="bg-white p-3 rounded-xl shadow-xl w-full max-w-md flex flex-col overflow-hidden max-h-[90vh]">
            ...
            <div className="overflow-y-auto p-6">
              ...
              <div className="space-y-2">
                <h5 className="text-xl font-bold text-gray-800">Card Judul {proccess}</h5>
                <p className="text-sm text-gray-600 leading-relaxed">
                  {/* Teks panjang di sini akan otomatis mendorong modal ke bawah */}
                  Some quick example text to build on the card title and make up the bulk of the card’s content...
                  (tambahkan teks lainnya...) Some quick example text to build on the card title and make up the bulk of the card’s content...
                  (tambahkan teks lainnya...) Some quick example text to build on the card title and make up the bulk of the card’s content...
                  (tambahkan teks lainnya...) Some quick example text to build on the card title and make up the bulk of the card’s content...
                  (tambahkan teks lainnya...) Some quick example text to build on the card title and make up the bulk of the card’s content...
                  (tambahkan teks lainnya...) Some quick example text to build on the card title and make up the bulk of the card’s content...
